<template>
  <div
    class="not-found-shell relative flex min-h-screen items-center justify-center overflow-hidden bg-gray-50 px-4 dark:bg-dark-950"
  >
    ...
    <div class="relative z-10 w-full max-w-md text-center">
      ...
      <div class="mb-8">
        <div class="relative inline-block">
          <span class="not-found-code text-[12rem] font-bold leading-none text-gray-100 dark:text-dark-800"
            >404</span
          >
          <div class="absolute inset-0 flex items-center justify-center">
            <div
              class="not-found-icon flex h-24 w-24 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 shadow-lg shadow-primary-500/30"
            >
              <svg
