export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      batchHealthCheckTitle: 'Batch Account Health Check',
      batchHealthCheckScope: 'Scope',
      batchHealthCheckScopeHint: 'This run will test {count} account(s).',
      batchHealthCheckSelectedScope: 'Selected accounts ({count})',
      batchHealthCheckCurrentPage: 'Current page accounts ({count})',
      batchHealthCheckModel: 'Test Model',
      batchHealthCheckModelHint: 'Optional. Leave empty to use the default test model for each platform.',
      batchHealthCheckCustomModel: 'Custom model',
      batchHealthCheckUseDefaultModel: 'Use account default model',
      batchHealthCheckMixedPlatformWarning: 'Multiple platforms are included in the current scope. If you specify a model, the same model will be sent to every account; leaving it empty is safer.',
      batchHealthCheckTargetCount: 'Targets',
      batchHealthCheckSuccessCount: 'Succeeded',
      batchHealthCheckFailedCount: 'Failed',
      batchHealthCheckCleanupSelected: 'Pending Cleanup',
      batchHealthCheckResults: 'Health Check Results',
      batchHealthCheckResultsHint: 'Failed accounts can be selected and physically deleted.',
      batchHealthCheckLatency: 'Latency',
      batchHealthCheckMessage: 'Result',
      batchHealthCheckRunning: 'Calling upstream APIs account by account. Please wait...',
      batchHealthCheckStart: 'Start Health Check',
      batchHealthCheckEmpty: 'No results yet. Click "Start Health Check" to run it.',
      batchHealthCheckEmptyScope: 'There are no accounts to test in the current scope.',
      batchHealthCheckSuccess: 'Health check completed. {count} account(s) succeeded.',
      batchHealthCheckPartial: 'Health check completed: {success} succeeded, {failed} failed.',
      batchHealthCheckFailed: 'Batch health check failed',
      batchHealthCheckDeleted: 'Deleted',
      batchHealthCheckRecovered: 'Runtime state recovered',
      batchHealthCheckSelectAllFailed: 'Select all failed',
      batchHealthCheckClearFailedSelection: 'Clear failed selection',
      batchHealthCheckCleanupFailed: 'Delete Failed Accounts',
      batchHealthCheckCleanupConfirm: 'Physically delete the selected {count} failed account(s)? This cannot be undone.',
      batchHealthCheckCleanupSuccess: 'Deleted {count} failed account(s)',
      batchHealthCheckCleanupPartial: 'Cleanup finished: {success} succeeded, {failed} failed.',
      batchHealthCheckCleanupFailedMessage: 'Failed to delete failed accounts',
      intelligentScheduling: {
        title: 'Intelligent Scheduling',
        scope: 'Scope',
        selectedScope: 'Selected accounts ({count})',
        scopeHint: 'Only the selected accounts will be tested and updated.',
        model: 'Test Model',
        modelHint: 'Optional. Leave empty to use the default test model for each platform.',
        useDefaultModel: 'Use account default model',
        mixedPlatformWarning: 'The selected accounts span multiple platforms. If you specify a model, the same model will be sent to every account; leaving it empty is safer.',
        strategyTitle: 'Update Strategy',
        strategyHint: 'Successful accounts are sorted by latency. Lower latency gets a smaller priority value, and load factor is scaled from the current effective load factor by relative latency, capped at 4x.',
        targetCount: 'Targets',
        testSuccessCount: 'Test Passed',
        appliedCount: 'Applied',
        unchangedCount: 'Unchanged',
        results: 'Scheduling Results',
        resultsHint: 'Only accounts that pass the test are updated. Failed accounts keep their existing settings.',
        latency: 'Latency',
        priorityChange: 'Priority',
        loadFactorChange: 'Load Factor',
        message: 'Result',
        running: 'Testing selected accounts and applying scheduling weights. Please wait...',
        start: 'Run And Apply',
        empty: 'No results yet. Click "Run And Apply" to start.',
        emptyScope: 'Please select at least one account first.',
        success: 'Applied intelligent scheduling to {count} account(s).',
        partial: 'Applied to {applied} account(s); {unchanged} account(s) were left unchanged.',
        failed: 'Intelligent scheduling failed',
