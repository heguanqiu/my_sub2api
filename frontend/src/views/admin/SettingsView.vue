            ...
            <div class="space-y-6 p-6">
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.contactImageUrl") }}
                </label>
                <input
                  v-model="form.contact_image_url"
                  type="url"
                  class="input font-mono text-sm"
                  :placeholder="t('admin.settings.site.contactImageUrlPlaceholder')"
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.contactImageUrlHint") }}
                </p>
              </div>
          ...
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            ...
            <p class="mt-1.5 flex flex-wrap gap-x-3 gap-y-1 text-xs">
              ...
              <router-link
                ...
                class="inline-flex items-center gap-1 text-primary-600 hover:underline dark:text-primary-400"
              >
                {{ t('admin.settings.features.availableChannels.groupsLink') }}
                <span aria-hidden="true">→</span>
              </router-link>
            </p>
          </div>
...
async function saveSettings() {
  ...
  try {
    ...
    if (!isValidHttpUrl(form.contact_image_url)) form.contact_image_url = "";
    ...
    const payload: UpdateSettingsRequest = {
      ...
      contact_image_url: form.contact_image_url,
