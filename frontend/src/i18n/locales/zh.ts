export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      testAccount: '测试账号',
      batchHealthCheck: '一键测活',
      batchHealthCheckTitle: '批量账号测活',
      batchHealthCheckScope: '测活范围',
      batchHealthCheckScopeHint: '本次将测试 {count} 个账号。',
      batchHealthCheckSelectedScope: '仅测已选账号（{count}）',
      batchHealthCheckCurrentPage: '测当前页账号（{count}）',
      batchHealthCheckModel: '测试模型',
      batchHealthCheckModelHint: '可选。留空时，每个账号将使用对应平台的默认测试模型。',
      batchHealthCheckCustomModel: '自定义模型',
      batchHealthCheckUseDefaultModel: '按账号默认模型测试',
      batchHealthCheckMixedPlatformWarning: '当前范围包含多个平台。若手动指定模型，会对所有账号使用同一个模型；建议留空以使用各平台默认测试模型。',
      batchHealthCheckTargetCount: '目标账号数',
      batchHealthCheckSuccessCount: '成功',
      batchHealthCheckFailedCount: '异常',
      batchHealthCheckCleanupSelected: '待清理',
      batchHealthCheckResults: '测活结果',
      batchHealthCheckResultsHint: '异常账号可勾选后执行物理删除。',
      batchHealthCheckLatency: '耗时',
      batchHealthCheckMessage: '结果信息',
      batchHealthCheckRunning: '正在逐个调用上游 API 测活，请稍候...',
      batchHealthCheckStart: '开始测活',
      batchHealthCheckEmpty: '暂无测活结果，点击“开始测活”执行。',
      batchHealthCheckEmptyScope: '当前没有可测活的账号。',
      batchHealthCheckSuccess: '测活完成，成功 {count} 个账号',
      batchHealthCheckPartial: '测活完成：成功 {success} 个，异常 {failed} 个',
      batchHealthCheckFailed: '批量测活失败',
      batchHealthCheckDeleted: '已删除',
      batchHealthCheckRecovered: '已恢复运行态',
      batchHealthCheckSelectAllFailed: '全选异常账号',
      batchHealthCheckClearFailedSelection: '清空异常选择',
      batchHealthCheckCleanupFailed: '清理异常账号',
      batchHealthCheckCleanupConfirm: '确认物理删除选中的 {count} 个异常账号吗？此操作不可撤销。',
      batchHealthCheckCleanupSuccess: '已物理删除 {count} 个异常账号',
      batchHealthCheckCleanupPartial: '清理完成：成功 {success} 个，失败 {failed} 个',
      batchHealthCheckCleanupFailedMessage: '清理异常账号失败',
      intelligentScheduling: {
        title: '智能调度安排',
        scope: '调度范围',
        selectedScope: '已选账号（{count}）',
        scopeHint: '仅对当前选中的账号执行测试并更新调度参数。',
        model: '测试模型',
        modelHint: '可选。留空时，每个账号将使用对应平台的默认测试模型。',
        useDefaultModel: '按账号默认模型测试',
        mixedPlatformWarning: '当前选择跨越多个平台。若手动指定模型，会对所有账号使用同一个模型；建议留空以使用各平台默认测试模型。',
        strategyTitle: '调整策略',
        strategyHint: '仅对测试成功的账号生效。系统会按延迟从低到高排序，延迟越低优先级值越小；负载因子基于当前有效负载因子按相对延迟放大，最大不超过 4 倍。',
        targetCount: '目标账号数',
        testSuccessCount: '测试通过',
        appliedCount: '已应用',
        unchangedCount: '未变更',
        results: '调度结果',
        resultsHint: '测试失败的账号不会改动原有 priority 和 load_factor。',
        latency: '延迟',
        priorityChange: '优先级',
        loadFactorChange: '负载因子',
        message: '结果信息',
        running: '正在测试选中账号并应用调度参数，请稍候...',
        start: '开始测算并应用',
        empty: '暂无结果，点击“开始测算并应用”执行。',
        emptyScope: '请先至少选择一个账号。',
        success: '已为 {count} 个账号应用智能调度',
        partial: '已应用 {applied} 个账号，另有 {unchanged} 个账号保持不变',
        failed: '智能调度执行失败',
        statusApplied: '已应用',
        statusTested: '已测试',
