...
// The InviteLinkFunc type is an adapter to allow the use of ordinary
// function as InviteLink mutator.
type InviteLinkFunc func(context.Context, *ent.InviteLinkMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f InviteLinkFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.InviteLinkMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.InviteLinkMutation", m)
}

// The InviteRewardLedgerFunc type is an adapter to allow the use of ordinary
// function as InviteRewardLedger mutator.
type InviteRewardLedgerFunc func(context.Context, *ent.InviteRewardLedgerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f InviteRewardLedgerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.InviteRewardLedgerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.InviteRewardLedgerMutation", m)
}

// The InvoiceDocumentFunc type is an adapter to allow the use of ordinary
// function as InvoiceDocument mutator.
type InvoiceDocumentFunc func(context.Context, *ent.InvoiceDocumentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f InvoiceDocumentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.InvoiceDocumentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.InvoiceDocumentMutation", m)
}
