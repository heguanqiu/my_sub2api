export default {
  ...
  auth: {
    ...
    invitationCodeLockedHint: '邀请码已由邀请链接自动带入。如需更换，请重新打开其他邀请链接。',
  ...
  availableChannels: {
    title: '模型广场',
    description: '按当前账号可访问分组展示模型、厂商、倍率与实际展示单价',
    searchPlaceholder: '搜索模型 ID、厂商或分组...',
    empty: '暂无可用模型',
    ...
    source: '来源',
    priceScope: '展示价',
    lowestAvailablePrice: '最低可用价',
    selectedGroupPrice: '当前分组价',
    lastUpdated: '最后同步：{time}',
    modelId: '模型 ID',
    details: '查看详情',
    closeDetails: '关闭详情',
    groupAccess: '分组访问与价格',
    ...
    apiExample: '调用示例',
    copyExample: '复制调用示例',
    exampleCopied: '调用示例已复制',
    openPlayground: '打开在线对话测试',
    copyModel: '复制模型 ID',
    ...
    pricing: {
      ...
      imageRequestPrice: '图片生成',
      perRequestPrice: '每次请求',
      intervals: '阶梯定价',
      unitPerMillion: '/ M Tok',
      unitPerRequest: '/ 次'
    }
  },
  ...
  referral: {
    title: '邀请中心',
    description: '管理您的邀请注册链接、邀请用户和奖励记录。',
    myLink: '邀请注册链接',
    linkHint: '分享此注册链接后，新用户注册时会自动与您建立邀请关系。',
    status: '状态',
    regenerate: '重新生成',
    disable: '禁用',
    revoke: '作废',
  ...
  sales: {
    ...
    referralLinkHint: '请直接复制并分享此链接，前端不会额外拼接 owner 或 sales 参数。',
    openRegisterPage: '打开注册链接',
    inviteesDescription: '查看通过你的专属邀请注册链接注册的客户。',
    rewardsDescription: '查看邀请奖励记录与发放状态。',
    rechargeRecords: '充值记录',
    customerRechargeRecords: '客户充值记录',
    ordersDescription: '查看你名下客户的充值订单记录，并按状态或支付方式筛选。',
    customerOrdersDescription: '查看该客户的充值订单记录。',
    backToCustomers: '返回客户列表',
    viewCustomerOrders: '查看客户订单'
  },
  ...
  admin: {
    upstreams: {
      title: '上游管理',
      description: '管理外部 sub2api/newapi 上游、同步分组、API、倍率与调度预览',
      searchPlaceholder: '搜索上游',
      create: '创建上游',
      edit: '编辑上游',
      emptyTitle: '还没有上游',
      emptyDescription: '创建外部上游后，可同步分组、API、倍率，并预览调度决策。',
      viewDetails: '查看详情',
      sync: '同步',
      syncNow: '立即同步',
      testLogin: '测试登录',
      ...
      weight: '权重',
      cost: '成本',
      localOpenAIGroups: '本地 OpenAI 分组',
      syncedGroups: '已同步分组',
      syncedAPIKeys: '已同步 API 密钥',
      noGroups: '暂无已同步分组',
      noAPIKeys: '暂无已同步 API 密钥',
      schedulePreview: '调度预览',
      preview: '预览',
      selected: '选中',
      filtered: '已过滤',
      selectTitle: '选择一个上游',
      selectDescription: '在这里查看已同步分组、API 密钥、倍率和调度解释。',
      basicConfig: '基础配置',
      name: '名称',
      baseURL: 'Base URL',
      ...
      retryMax: '重试次数',
      probeInterval: '探测间隔秒数',
      probeEnabled: '启用探测',
      noLocalOpenAIGroups: '暂无本地 OpenAI 分组',
      noRemoteGroup: '不映射上游分组',
      forwardCredential: '转发凭据',
      credentialName: '凭据名称',
      authType: '鉴权类型',
      authCustom: '自定义',
      forwardAPIKey: '转发 API Key',
      forwardEnabled: '启用',
      adminAuth: '上游管理鉴权',
      authMode: '鉴权模式',
      loginURL: '登录 URL',
      ...
      weightPriority: '权重 / 优先级',
      groupsKeys: '分组 / 密钥',
      lastSync: '最后同步',
      modelPlaceholder: '模型，可选',
      configuredPassword: '已配置',
      detailTitle: '上游详情',
      previewSync: '预览同步',
      probe: '探测',
      healthBoard: '健康看板',
      ...
      latestProbe: '最近探针',
      schedulableKeys: '可调度密钥',
      apiKeyMappings: 'API key 配置',
      apiKeyMappingsHint: '逐个配置上游 API key，并选择它映射到哪些本地 OpenAI 分组；调度会选择具体 key。',
      keyConfigured: '已配置',
      keyNotConfigured: '未配置',
      keySchedulable: '可调度',
      keyNotSchedulable: '不可调度',
      upstreamAPIKeySecret: '上游 API key',
      keepExistingKey: '留空则保留已配置密钥',
      mappedLocalGroups: '映射本地分组',
      ...
      availableModelsPlaceholder: '每行一个模型或通配符，例如：\ngpt-4o\ngpt-4.1-*',
      modelsSaved: '可用模型已保存',
      modelsSaveFailed: '保存可用模型失败',
      alerts: '告警',
      alertCritical: '严重',
      alertWarning: '警告',
      alertInfo: '提示',
      resolve: '解除',
      syncDiffPreview: '同步差异预览',
      applyPreview: '确认应用',
      changes: '变更',
      unschedulable: '不可调度',
      rateChanges: '倍率变化',
      anyLocalGroup: '任意本地分组',
      candidateAPIKeys: '候选 API 密钥',
      filteredAPIKeys: '已过滤 API 密钥',
      scoreHealth: '健康',
      scorePerformance: '性能',
      scoreCost: '成本',
      scoreCapacity: '容量',
      scorePriority: '优先',
      policyConfig: '治理策略',
      failuresToCircuit: '连续失败熔断阈值',
      ttftThreshold: '首 token 降权阈值（毫秒）',
      errorRateThreshold: '错误率降权阈值',
      recoveryInterval: '恢复探测间隔（秒）',
      recoverySuccesses: '恢复所需成功次数',
      ignoredCodes: '忽略状态码',
      circuitCodes: '立即熔断状态码',
      statusCodesPlaceholder: '例如 400,404',
      alertEnabled: '启用告警',
      costReconciliation: '成本对账',
      costDimension: '对账维度',
      costWindowHours: '统计窗口（小时）',
      costByUpstream: '上游',
      costByRemoteGroup: '上游分组',
      costByAPIKey: 'API 密钥',
      costByLocalGroup: '本地分组',
      costByUser: '用户',
      costByModel: '模型',
      localBilled: '本地计费',
      upstreamCost: '上游成本',
      ...
      syncApplied: '同步已应用',
      syncApplyFailed: '应用同步预览失败',
      unknownAPIKey: '未知密钥',
      probeSkipped: '探测已跳过',
      probeSucceeded: '探测成功',
      probeFailed: '探测失败',
      policySaved: '治理策略已保存',
      policySaveFailed: '保存治理策略失败',
      healthLoadFailed: '加载健康数据失败',
      alertResolveFailed: '解除告警失败',
      costLoadFailed: '加载成本报表失败',
      costReportNoReset: '未设置统计重置时间',
      noCostReportItems: '暂无成本对账数据',
      costReportResetAt: '统计起点',
      resetCostReport: '重置',
      resetCostReportTitle: '重置成本统计',
      resetCostConfirmPrefix: '重置',
      resetCostConfirmSuffix: '的成本统计？历史调用记录会保留，新的统计起点会安排在今晚 0 点生效。',
      costReportReset: '已安排今晚 0 点重置成本统计',
      costResetFailed: '重置成本统计失败',
      eventProbeSuccess: '探测成功',
      eventProbeFailure: '探测失败',
      eventRuntimeSuccess: '请求成功',
      eventRuntimeError: '请求错误',
      eventStreamInterrupted: '流式中断',
      eventIgnored: '已忽略',
      loadFailed: '加载上游失败',
      detailFailed: '加载上游详情失败',
      localGroupsLoadFailed: '加载本地 OpenAI 分组失败',
      saved: '上游已保存',
      saveFailed: '保存上游失败',
      syncCompleted: '同步完成',
      syncSuccess: '同步成功',
    ...
    plugins: {
      ...
      downloadCount: '下载次数',
      downloadSource: '下载来源',
      downloadSourceHint: '用户始终通过本站服务器下载。可上传本地插件包，也可填写远程资源地址。',
      sourceUpload: '上传文件',
      sourceRemote: '资源地址',
      packageFile: '插件包',
      resourceURL: '资源地址',
      resourceURLHint: '填写 HTTP/HTTPS 源地址；用户端下载按钮仍走本站服务器下载接口。',
      resourceURLInvalid: '资源地址必须以 http:// 或 https:// 开头',
      resourceFileName: '下载文件名',
      resourceFileSize: '展示大小（字节）',
      icon: '图标',
      uploadPackage: '上传插件包',
      uploadIcon: '上传图标',
    ...
    ops: {
      ...
      tooltips: {
        ...
        ttft: '首 Token 延迟，衡量流式响应首个有效出站事件返回速度。',
    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: '模型广场',
          description: '向已登录用户展示他们能访问的模型、分组倍率和实际展示价格。模型基准价来自渠道定价，展示价由分组倍率换算。',
          configureLink: '前往 渠道管理 > 渠道定价 配置模型基准价',
          groupsLink: '前往分组管理配置倍率与可见范围',
          enabled: '启用模型广场',
          enabledHint: '关闭后用户端侧边栏入口隐藏，模型广场接口返回空数组。',
        },
        riskControl: {
          title: '风控中心',
      ...
      site: {
        ...
        contactImageUrl: '客服图片地址',
        contactImageUrlPlaceholder: 'https://example.com/support-qr.png',
        contactImageUrlHint: '可填写客服二维码或 QQ 群二维码图片 URL，将展示在联系客服弹窗中',
        docUrl: '文档链接',
      ...
      payment: {
        ...
        inviteRewardEnabled: '启用邀请返利',
        inviteRewardEnabledHint: '被邀请用户完成符合条件的余额充值后，向邀请人发放返利',
        inviteRewardRate: '返利比例',
        inviteRewardRateHint: '按到账余额金额的百分比计算邀请奖励',
        inviteRewardTriggerMode: '返利触发方式',
        inviteRewardTriggerModeHint: '选择仅首笔余额充值返利，或每笔余额充值都返利',
        inviteRewardTriggerFirstBalanceOrder: '首笔余额充值',
        inviteRewardTriggerEveryBalanceOrder: '每笔余额充值',
        preview: '预览',
        ...
        invoice: {
          title: '发票 SDK 配置',
          description: '配置用户自助开票的最低金额、销方信息和 fapiaoapi SDK 凭证。',
          currency: '币种：{currency}',
          minAmount: '单次最低开票金额',
          minAmountHint: '0 表示不限制最低开票金额。',
          sdkBaseUrl: 'SDK API 地址',
          sdkAppKey: 'AppKey',
          sdkAppSecret: 'AppSecret',
          taxpayerId: '纳税人识别号',
          sellerName: '销方名称',
          sellerAddressPhone: '销方地址电话',
          sellerBankAccount: '销方开户行账号',
          username: '税务账号用户名',
          password: '税务账号密码',
          accountType: '账号类型',
          debug: '启用 SDK 调试日志',
          defaultContent: '默认开票内容',
          taxRate: '税率',
          taxRateHint: '例如 0.01 表示 1%。',
          taxCode: '税收分类编码',
          typeCode: '发票类型代码',
          secretConfigured: '已配置，留空将保留当前值。',
          secretNotConfigured: '尚未配置。',
          requiredHint: '启用后，AppKey/AppSecret、税号、销方信息、账号、默认内容、税收编码和发票类型代码均需完整配置。',
          loadFailed: '发票配置加载失败',
          saveFailed: '发票配置保存失败',
        },
      },
  ...
  payment: {
    ...
    invoice: {
      title: '发票管理',
      description: '查看可开票金额，管理发票抬头，并提交开票申请',
      disabledHint: '自助开票暂未开放，请联系管理员。',
      manageProfiles: '发票抬头',
      apply: '申请开票',
      history: '申请历史',
      historyHint: '开票申请提交后会记录处理状态和发票文件。',
      emptyHistory: '暂无开票申请',
      emptyHistoryHint: '满足最低开票金额后，可以在此提交开票申请。',
      totalPaid: '累计已支付',
      invoicedAmount: '已开票额度',
      reservedAmount: '处理中额度',
      availableAmount: '可开票额度',
      minAmountHint: '单次最低开票金额：{amount}',
      profileDialogTitle: '发票抬头管理',
      applicationDialogTitle: '申请开票',
      noProfiles: '暂无发票抬头，请先添加一个抬头。',
      addProfile: '新增抬头',
      editProfile: '编辑抬头',
      deleteProfile: '删除抬头',
      ...
      titleType: '抬头类型',
      titleName: '发票抬头',
      titleNamePlaceholder: '请输入个人姓名或公司名称',
      taxNo: '纳税人识别号',
      taxNoPlaceholder: '企业抬头需填写税号',
      ...
      bankAccount: '开户行及账号',
      bankAccountPlaceholder: '开户银行及银行账号',
      selectProfile: '选择发票抬头',
      selectProfilePlaceholder: '请选择抬头',
      applicationAmount: '开票金额',
      content: '开票内容',
      contentPlaceholder: '例如：信息技术服务',
      remark: '留言/备注',
      remarkPlaceholder: '如有特殊要求可填写在这里',
      submitApplication: '提交申请',
      submitting: '提交中...',
      submitSuccessIssued: '开票成功',
      submitSuccessPending: '开票申请已提交，请等待处理',
      invoiceNo: '发票号码',
      titleTypes: {
        personal: '个人',
        company: '企业',
      ...
      validation: {
        titleNameRequired: '发票抬头不能为空',
        profileRequired: '请选择发票抬头',
        emailInvalid: '请输入有效的收票邮箱',
        amountRequired: '请输入开票金额',
        amountBelowMin: '开票金额不能低于 {amount}',
        amountExceedsAvailable: '开票金额不能超过可开票额度 {amount}',
        contentRequired: '请输入开票内容',
      },
      errors: {
        INVOICE_DISABLED: '自助开票暂未开放',
        INVOICE_CONFIG_INCOMPLETE: '发票配置不完整，请联系管理员补充：{missing}',
        INVALID_INVOICE_AMOUNT: '开票金额无效',
        INVOICE_AMOUNT_BELOW_MINIMUM: '开票金额低于最低金额 {min}',
        INVOICE_AMOUNT_EXCEEDS_AVAILABLE: '开票金额超过可开票额度 {available}',
        INVALID_INVOICE_EMAIL: '收票邮箱格式不正确',
        INVOICE_PROFILE_NOT_FOUND: '发票抬头不存在或已删除',
        INVALID_INVOICE_TITLE_TYPE: '发票抬头类型无效',
        INVALID_INVOICE_TITLE: '发票抬头不能为空',
        INVALID_INVOICE_TAX_NO: '企业抬头必须填写纳税人识别号',
