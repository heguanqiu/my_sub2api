...
const form = reactive({ email: '', password: '', username: '', role: 'user' as 'admin' | 'sales' | 'user', notes: '', balance: 0, concurrency: 1 })
...
watch(() => props.show, (v) => { if(v) Object.assign(form, { email: '', password: '', username: '', role: 'user', notes: '', balance: 0, concurrency: 1 }) })
