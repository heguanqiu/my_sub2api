<template>
  <Teleport to="body">
    <Transition name="popup-fade">
      ...
      >
        <div
          class="announcement-popup-modal w-full max-w-[680px] overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/5 dark:bg-dark-800 dark:ring-white/10"
          @click.stop
        >
