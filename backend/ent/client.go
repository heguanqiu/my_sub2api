...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.InviteRewardLedger, c.PaymentAuditLog, c.PaymentOrder,
		c.PaymentProviderInstance, c.PendingAuthSession, c.Plugin, c.PromoCode,
...
type (
	hooks struct {
		...
		InviteRewardLedger, PaymentAuditLog, PaymentOrder, PaymentProviderInstance,
		PendingAuthSession, Plugin, PromoCode, PromoCodeUsage, Proxy, RedeemCode,
