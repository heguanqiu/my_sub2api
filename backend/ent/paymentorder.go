...
type PaymentOrder struct {
	...
	// OwnerSalesIDSnapshot holds the value of the "owner_sales_id_snapshot" field.
	OwnerSalesIDSnapshot *int64 `json:"owner_sales_id_snapshot,omitempty"`
	// InvitedByUserIDSnapshot holds the value of the "invited_by_user_id_snapshot" field.
	InvitedByUserIDSnapshot *int64 `json:"invited_by_user_id_snapshot,omitempty"`
	// InviteRewardStatus holds the value of the "invite_reward_status" field.
...
func (_m *PaymentOrder) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case paymentorder.FieldOwnerSalesIDSnapshot:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field owner_sales_id_snapshot", values[i])
			} else if value.Valid {
				_m.OwnerSalesIDSnapshot = new(int64)
				*_m.OwnerSalesIDSnapshot = value.Int64
			}
		case paymentorder.FieldInvitedByUserIDSnapshot:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field invited_by_user_id_snapshot", values[i])
			} else if value.Valid {
				_m.InvitedByUserIDSnapshot = new(int64)
				*_m.InvitedByUserIDSnapshot = value.Int64
			}
		case paymentorder.FieldInviteRewardStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field invite_reward_status", values[i])
			} else if value.Valid {
				_m.InviteRewardStatus = value.String
			}
		case paymentorder.FieldInviteRewardLedgerID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field invite_reward_ledger_id", values[i])
			} else if value.Valid {
...
func (_m *PaymentOrder) String() string {
	...
	builder.WriteString(", ")
	if v := _m.OwnerSalesIDSnapshot; v != nil {
		builder.WriteString("owner_sales_id_snapshot=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.InvitedByUserIDSnapshot; v != nil {
		builder.WriteString("invited_by_user_id_snapshot=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	builder.WriteString("invite_reward_status=")
	builder.WriteString(_m.InviteRewardStatus)
	builder.WriteString(", ")
