...
const (
	InviteLinkStatusActive   = "active"
	InviteLinkStatusDisabled = "disabled"
	InviteLinkStatusRevoked  = "revoked"
)

// Invite reward constants
const (
	InviteRewardTypeBalance = "balance"

	InviteRewardStatusPending   = "pending"
	InviteRewardStatusGranted   = "granted"
	InviteRewardStatusReversed  = "reversed"
	InviteRewardStatusCancelled = "cancelled"
)

// Payment order invite reward snapshot status constants
const (
	OrderInviteRewardStatusNotApplicable     = "not_applicable"
	OrderInviteRewardStatusPendingEvaluation = "pending_evaluation"
	OrderInviteRewardStatusGranted           = "granted"
	OrderInviteRewardStatusReversed          = "reversed"
