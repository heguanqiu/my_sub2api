		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"payment_help_text": "",
					"payment_invite_reward_enabled": false,
					"payment_invite_reward_rate": 0,
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	adminService := service.NewAdminService(userRepo, groupRepo, &accountRepo, nil, proxyRepo, apiKeyRepo, redeemRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
