...
const form = reactive({ email: '', password: '', username: '', role: 'user' as 'sales' | 'user', notes: '', balance: '', concurrency: 1, rpm_limit: 0 })
...
watch(() => props.show, (v) => { if(v) Object.assign(form, { email: '', password: '', username: '', role: 'user', notes: '', balance: '', concurrency: 1, rpm_limit: 0 }) })
