export default {
  ...
  common: {
    ...
    noContactInfo: 'No support information configured.',
    add: 'Add',
  ...
  auth: {
    ...
    invitationCodeLockedHint: 'This invitation code was applied from the invite link. Open a different invite link if you need to change it.',
  ...
  availableChannels: {
    ...
    description: 'Models available to your groups, with vendors, multipliers and effective display prices',
    searchPlaceholder: 'Search model ID, vendor or group...',
    ...
    source: 'Source',
    priceScope: 'Display price',
    lowestAvailablePrice: 'Lowest available',
    selectedGroupPrice: 'Selected group',
    lastUpdated: 'Last sync: {time}',
    modelId: 'Model ID',
    details: 'View details',
    closeDetails: 'Close details',
    groupAccess: 'Group access and pricing',
    selected: 'Current display price',
    channels: 'Channels',
    noChannels: 'No channels bound',
    apiExample: 'API example',
    copyExample: 'Copy API example',
    exampleCopied: 'API example copied',
    ...
    pricing: {
      ...
      imageRequestPrice: 'Image Generation',
  ...
  referral: {
    ...
    description: 'Manage your invite registration link, invitees, and reward history.',
    myLink: 'Invite Registration Link',
    linkHint: 'Share this registration link so new users are automatically linked to your referral account.',
    status: 'Status',
    regenerate: 'Regenerate',
    disable: 'Disable',
    revoke: 'Revoke',
    invitees: 'Direct Invitees',
  ...
  sales: {
    ...
    referralLinkHint: 'Share this URL directly. The frontend does not append owner or sales query parameters.',
    openRegisterPage: 'Open Registration Page',
    inviteesDescription: 'Customers who registered through your referral registration link.',
    rewardsDescription: 'Referral reward history and payout status.',
    rechargeRecords: 'Recharge Records',
    customerRechargeRecords: 'Customer Recharge Records',
    ordersDescription: 'Review recharge orders for customers assigned to you, with status and payment-type filters.',
    customerOrdersDescription: 'Recharge records for this customer.',
  ...
  admin: {
    upstreams: {
      ...
      description: 'Manage external sub2api/newapi upstreams, synced groups, API keys, cost multipliers, and routing previews',
      searchPlaceholder: 'Search upstreams',
      create: 'Create upstream',
      edit: 'Edit upstream',
      emptyTitle: 'No upstreams yet',
      emptyDescription: 'Create an external upstream to sync groups, API keys, multipliers, and preview routing decisions.',
      ...
      weight: 'Weight',
      cost: 'Cost',
      localOpenAIGroups: 'Local OpenAI groups',
      syncedGroups: 'Synced groups',
      syncedAPIKeys: 'Synced API keys',
      noGroups: 'No synced groups',
      noAPIKeys: 'No synced API keys',
      schedulePreview: 'Schedule preview',
      preview: 'Preview',
      selected: 'Selected',
      filtered: 'Filtered',
      selectTitle: 'Select an upstream',
      selectDescription: 'Review synced groups, API keys, multipliers, and routing explanations here.',
      ...
      routingConfig: 'Routing and timeout',
      priority: 'Priority',
      ...
      probeEnabled: 'Enable probes',
      noLocalOpenAIGroups: 'No local OpenAI groups',
      noRemoteGroup: 'No remote group',
      forwardCredential: 'Forwarding credential',
      credentialName: 'Credential name',
      authType: 'Auth type',
      authCustom: 'Custom',
      forwardAPIKey: 'Forward API key',
      forwardEnabled: 'Enabled',
      adminAuth: 'Upstream admin auth',
      authMode: 'Auth mode',
      loginURL: 'Login URL',
      username: 'Username',
      password: 'Password',
      ...
      schedulableKeys: 'Schedulable keys',
      apiKeyMappings: 'API key configuration',
      apiKeyMappingsHint: 'Configure each upstream API key and map it to local OpenAI groups. Scheduling selects a concrete key.',
      keyConfigured: 'Configured',
      keyNotConfigured: 'Not configured',
      keySchedulable: 'Schedulable',
      keyNotSchedulable: 'Not schedulable',
      upstreamAPIKeySecret: 'Upstream API key',
      keepExistingKey: 'Leave blank to keep the configured key',
      mappedLocalGroups: 'Mapped local groups',
      noMappedLocalGroups: 'No local groups mapped',
      keyConfigSaved: 'API key configuration saved',
      keyConfigSaveFailed: 'Failed to save API key configuration',
      availableModels: 'Available models',
      allModels: 'All',
      availableModelsHint: 'Manage the models supported by this upstream. Empty means all models can be scheduled. * wildcards are supported.',
      availableModelsPlaceholder: 'One model or wildcard per line, for example:\ngpt-4o\ngpt-4.1-*',
      modelsSaved: 'Available models saved',
      modelsSaveFailed: 'Failed to save available models',
      alerts: 'Alerts',
      alertCritical: 'Critical',
      alertWarning: 'Warning',
      alertInfo: 'Info',
      resolve: 'Resolve',
      syncDiffPreview: 'Sync diff preview',
      applyPreview: 'Apply preview',
      changes: 'Changes',
      unschedulable: 'Unschedulable',
      rateChanges: 'Rate changes',
      anyLocalGroup: 'Any local group',
      candidateAPIKeys: 'Candidate API keys',
      filteredAPIKeys: 'Filtered API keys',
      scoreHealth: 'Health',
      scorePerformance: 'Performance',
      scoreCost: 'Cost',
      scoreCapacity: 'Capacity',
      scorePriority: 'Priority',
      policyConfig: 'Governance policy',
      failuresToCircuit: 'Consecutive failures to circuit',
      ttftThreshold: 'First token degrade threshold (ms)',
      errorRateThreshold: 'Error-rate degrade threshold',
      recoveryInterval: 'Recovery probe interval (seconds)',
      recoverySuccesses: 'Recovery successes required',
      ignoredCodes: 'Ignored status codes',
      circuitCodes: 'Immediate circuit status codes',
      statusCodesPlaceholder: 'e.g. 400,404',
      alertEnabled: 'Enable alerts',
      costReconciliation: 'Cost reconciliation',
      costDimension: 'Reconciliation dimension',
      costWindowHours: 'Window (hours)',
      costByUpstream: 'Upstream',
      costByRemoteGroup: 'Remote group',
      costByAPIKey: 'API key',
      costByLocalGroup: 'Local group',
      costByUser: 'User',
      costByModel: 'Model',
      localBilled: 'Local billed',
      ...
      syncApplyFailed: 'Failed to apply sync preview',
      unknownAPIKey: 'unknown key',
      ...
      healthLoadFailed: 'Failed to load upstream health',
      alertResolveFailed: 'Failed to resolve alert',
      costLoadFailed: 'Failed to load cost report',
      costReportNoReset: 'No cost reset time configured',
      noCostReportItems: 'No cost reconciliation data',
      costReportResetAt: 'Statistics start',
      resetCostReport: 'Reset',
      resetCostReportTitle: 'Reset cost statistics',
      resetCostConfirmPrefix: 'Reset',
      resetCostConfirmSuffix: 'cost statistics? Historical usage logs will be kept, and the new statistics start will take effect at midnight tonight.',
      costReportReset: 'Cost statistics reset scheduled for midnight tonight',
      costResetFailed: 'Failed to reset cost statistics',
      eventProbeSuccess: 'Probe success',
      eventProbeFailure: 'Probe failed',
      eventRuntimeSuccess: 'Request success',
      eventRuntimeError: 'Request error',
      ...
      localGroupsLoadFailed: 'Failed to load local OpenAI groups',
      ...
      previewFailed: 'Schedule preview failed',
    ...
    plugins: {
      ...
      downloadSourceHint: 'Users always download through this server. Use upload for local packages or resource URL for a remote source.',
      sourceUpload: 'Upload File',
      sourceRemote: 'Resource URL',
      packageFile: 'Package',
      resourceURL: 'Resource URL',
      resourceURLHint: 'HTTP/HTTPS source URL. The public download button still uses the server download endpoint.',
      resourceURLInvalid: 'Resource URL must start with http:// or https://',
      resourceFileName: 'Download File Name',
      resourceFileSize: 'Displayed Size (bytes)',
      icon: 'Icon',
    ...
    ops: {
      ...
      ttftLabel: 'First Token Latency (first_token_ms)',
      p50: 'p50:',
      p90: 'p90:',
      p95: 'p95:',
      p99: 'p99:',
      ...
      tooltips: {
        ...
        ttft: 'First token latency, measuring the speed of the first effective outbound streaming event.',
    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: 'Model Marketplace',
          description: 'Show logged-in users the models, groups and effective prices they can access. Base prices come from channel pricing; display prices are calculated from group multipliers.',
          configureLink: 'Configure base model prices in Channel Management > Channel Pricing',
          groupsLink: 'Configure group multipliers and visibility in Groups',
          enabled: 'Enable Model Marketplace',
          enabledHint: 'When off, the sidebar entry is hidden and the marketplace endpoint returns an empty list.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      site: {
        ...
        contactImageUrl: 'Support Image URL',
        contactImageUrlPlaceholder: 'https://example.com/support-qr.png',
        contactImageUrlHint: 'Optional support or group QR code image URL, shown in the contact support dialog.',
      ...
      payment: {
        ...
        inviteRewardEnabled: 'Enable Invite Reward',
        inviteRewardEnabledHint: 'Grant rewards to inviters when referred users complete qualifying balance recharges',
        inviteRewardRate: 'Invite Reward Rate',
        inviteRewardRateHint: 'Percentage of the credited balance amount granted as referral reward',
        inviteRewardTriggerMode: 'Invite Reward Trigger',
        inviteRewardTriggerModeHint: 'Choose whether rewards apply only to the first balance recharge or to every balance recharge',
        inviteRewardTriggerFirstBalanceOrder: 'First Balance Recharge',
        inviteRewardTriggerEveryBalanceOrder: 'Every Balance Recharge',
        preview: 'Preview',
        ...
        invoice: {
          title: 'Invoice SDK Settings',
          description: 'Configure the minimum invoice amount, seller information, and fapiaoapi SDK credentials for user self-service invoicing.',
          currency: 'Currency: {currency}',
          minAmount: 'Minimum Invoice Amount',
          minAmountHint: '0 means no minimum amount.',
          sdkBaseUrl: 'SDK API URL',
          sdkAppKey: 'AppKey',
          sdkAppSecret: 'AppSecret',
          taxpayerId: 'Taxpayer ID',
          sellerName: 'Seller Name',
          sellerAddressPhone: 'Seller Address and Phone',
          sellerBankAccount: 'Seller Bank and Account',
          username: 'Tax Account Username',
          password: 'Tax Account Password',
          accountType: 'Account Type',
          debug: 'Enable SDK Debug Logs',
          defaultContent: 'Default Invoice Content',
          taxRate: 'Tax Rate',
          taxRateHint: 'For example, 0.01 means 1%.',
          taxCode: 'Tax Classification Code',
          typeCode: 'Invoice Type Code',
          secretConfigured: 'Configured. Leave empty to keep the current value.',
          secretNotConfigured: 'Not configured.',
          requiredHint: 'When enabled, AppKey/AppSecret, taxpayer ID, seller info, account, default content, tax code, and invoice type code must be configured.',
          loadFailed: 'Failed to load invoice settings',
          saveFailed: 'Failed to save invoice settings',
        },
      },
      balanceNotify: {
        title: 'Balance Low Notification',
  ...
  payment: {
    ...
    invoice: {
      title: 'Invoices',
      description: 'View invoiceable balance, manage invoice titles, and submit invoice applications',
      disabledHint: 'Self-service invoicing is not available. Please contact an administrator.',
      manageProfiles: 'Invoice Titles',
      apply: 'Request Invoice',
      history: 'Application History',
      historyHint: 'Submitted invoice applications show processing status and invoice files here.',
      emptyHistory: 'No invoice applications yet',
      emptyHistoryHint: 'Once you meet the minimum amount, you can submit an invoice application here.',
      totalPaid: 'Total Paid',
      invoicedAmount: 'Invoiced Amount',
      reservedAmount: 'Processing Amount',
      availableAmount: 'Invoiceable Amount',
      minAmountHint: 'Minimum per invoice: {amount}',
      profileDialogTitle: 'Invoice Title Management',
      applicationDialogTitle: 'Request Invoice',
      noProfiles: 'No invoice title yet. Add one first.',
      addProfile: 'Add Title',
      editProfile: 'Edit Title',
      deleteProfile: 'Delete Title',
      deleteProfileConfirm: 'Delete "{name}"?',
      defaultProfile: 'Default',
      setDefault: 'Set as default title',
      titleType: 'Title Type',
      titleName: 'Invoice Title',
      titleNamePlaceholder: 'Enter personal name or company name',
      taxNo: 'Taxpayer ID',
      taxNoPlaceholder: 'Required for company titles',
      ...
      bankAccountPlaceholder: 'Bank name and bank account',
      selectProfile: 'Invoice Title',
      selectProfilePlaceholder: 'Select a title',
      applicationAmount: 'Invoice Amount',
      content: 'Invoice Content',
      contentPlaceholder: 'For example: Information Technology Services',
      remark: 'Message / Note',
      remarkPlaceholder: 'Add special requirements here',
      submitApplication: 'Submit',
      submitting: 'Submitting...',
      submitSuccessIssued: 'Invoice issued',
      submitSuccessPending: 'Invoice request submitted',
      ...
      validation: {
        titleNameRequired: 'Invoice title is required',
        profileRequired: 'Select an invoice title',
        emailInvalid: 'Enter a valid recipient email',
        amountRequired: 'Enter invoice amount',
        amountBelowMin: 'Invoice amount cannot be lower than {amount}',
        amountExceedsAvailable: 'Invoice amount cannot exceed available amount {amount}',
        contentRequired: 'Enter invoice content',
      },
      errors: {
        INVOICE_DISABLED: 'Self-service invoicing is not available',
        INVOICE_CONFIG_INCOMPLETE: 'Invoice configuration is incomplete. Contact an administrator: {missing}',
        INVALID_INVOICE_AMOUNT: 'Invalid invoice amount',
        INVOICE_AMOUNT_BELOW_MINIMUM: 'Invoice amount is below the minimum {min}',
        INVOICE_AMOUNT_EXCEEDS_AVAILABLE: 'Invoice amount exceeds available amount {available}',
        INVALID_INVOICE_EMAIL: 'Invalid recipient email',
        INVOICE_PROFILE_NOT_FOUND: 'Invoice title does not exist or was deleted',
        INVALID_INVOICE_TITLE_TYPE: 'Invalid invoice title type',
        INVALID_INVOICE_TITLE: 'Invoice title is required',
        INVALID_INVOICE_TAX_NO: 'Company titles require a taxpayer ID',
    ...
    result: {
      ...
      viewOrders: 'View Recharge Records',
    },
    currentBalance: 'Current Balance',
